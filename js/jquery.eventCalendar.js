...
;$.fn.eventCalendar = function(options){
	...
	//flags.wrap.find('.eventsCalendar-list .eventTitle').live('click',function(e){
		if(!eventsOpts.showDescription) {
			...
			if (!desc.find('a').size()) {
				...
				//desc.append(event.title+'<a href="#" id="runningD" class="bt">'+eventsOpts.txt_GoToEventUrl+'</a>')
			}
	...
	function dateSlider(show, year, month) {
		...
		for (dayCount = 1; dayCount <= daysOnTheMonth; dayCount++) {
			...
			if(dayCount==daysOnTheMonth){
				daysList.push('<li id="dayList_' + dayCount + '" rel="'+dayCount+'" class="eventsCalendar-day'+dayClass+'"><a href="#" id="gold-star">' + dayCount + '</a></li>');
			}
...
$.fn.eventCalendar.defaults = {
	...
	txt_noEvents: "It is not a running day ",
